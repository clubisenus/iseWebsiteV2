...
import animation from "../resources/animations/NightCycling.json"; // Change this according to the event
                    ...
                    <div className="inner">
                        <nav id="menu">
                            ...
                            <List>
                                ...
                                >
                                    <Link href={pageLinks.internal.domain}>
                                        Home
                                    </Link>
                                </ListItem>
                                <ListItem
                                    ...
                                    onClick={this.props.ToggleNavBar}
                                >
                                    <Link href={pageLinks.internal.about}>
                                        About Us
                                    </Link>
                                </ListItem>
                                <ListItem
                                ...
                                <Collapse in={this.state.showEvents}>
                                    <List>
                                        <ListItem
                                            ...
                                            onClick={this.props.ToggleNavBar}
                                        >
                                            <Link href={pageLinks.internal.bio}>
                                                Upcoming Events
                                            </Link>
                                        </ListItem>
                                        <ListItem
                                        ...
                                        <ListItem
                                            ...
                                            onClick={this.props.ToggleNavBar}
                                        >
                                            <Link href={pageLinks.events.day}>
                                                ISE Day
                                            </Link>
                                        </ListItem>
                                        <ListItem
                                        ...
                                        >
                                            <Link
                                                href={pageLinks.events.lasertag}
                                            >
                                                ISE Special Events
                                            </Link>
                                        </ListItem>
                                        ...
                                        >
                                            <Link href={pageLinks.events.bacc}>
                                                NUS ISE Business Analytics Case
                                                Competition
                                            </Link>
                                        </ListItem>
                                    </List>
                                ...
                                <ListItem
                                    ...
                                    onClick={this.props.ToggleNavBar}
                                >
                                    <Link href={pageLinks.internal.sponsors}>
                                        Sponsorships
                                    </Link>
                                </ListItem>
                                <ListItem
                                    ...
                                    onClick={this.props.ToggleNavBar}
                                >
                                    <Link href={pageLinks.internal.contact}>
                                        Contact Us
                                    </Link>
                                </ListItem>
                            </List>
                        ...
                        <section>
                            ...
                            <p>
                                Queries? Feedback? Feel free to reach out to us
                                here! Or you can DM us on Instagram :)
                            </p>
                            <ul className="contact">
                                <ContactLi className="icon solid fa-envelope">
                                    <a href={pageLinks.external.email}>
                                        club.ise.nus@gmail.com
                                    </a>
                                </ContactLi>
