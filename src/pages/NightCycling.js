...
import { nightcycling } from '../resources/events';
            ...
            <div className="inner">
                <section>
                    <header className="main">
                        <h1>{nightcycling.name}</h1>
                    </header>

                    <Slide easing="ease">
                        {(nightcycling.images.length > 0 ? nightcycling.images : [placeholderImage]).map((image, index) => (
                    ...
                    <h3 style={{ marginTop: '150px' }}>{nightcycling.description}</h3>
                    <hr className="major" />
                </section>
            </div>
        </div>
